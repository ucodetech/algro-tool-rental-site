   ...
   if ($row) {
     foreach ($row as $active) {
       ...
       <div class="col-lg-4">
         ...
         <br>
         <?
         echo $active->user_fullname . '- ID-' . $active->user_id ;
         ?>
...
if(isset($_POST['action']) && $_POST['action'] == "totPayment"){
  $totPayment =  $general->totalCountPayment();
   foreach ($totPayment as $row) {
     echo money($row->total);
 }
}
